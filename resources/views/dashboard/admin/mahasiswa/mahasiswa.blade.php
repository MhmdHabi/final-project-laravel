                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-300">
                        <tr>
                            ...
                            <th class="px-3 py-3 border border-gray-400 text-left text-md text-black text-center w-32">
                                Action
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-3 py-4 border border-gray-400">123456789</td>
                            <td class="px-3 py-4 border border-gray-400">ss@gmail.com</td>
                            <td class="px-3 py-4 border border-gray-400">John Doe</td>
                            <td class="px-3 py-4 border border-gray-400">08123456789</td>
                            <td class="px-3 py-4 border border-gray-400">Teknik Informatika</td>
                            ...
                            <td class="px-3 py-4 border border-gray-400">
                                ...
                                <a href="{{ route('admin.data_mahasiswa.edit') }}"><button
                                        class="px-4 py-2 bg-blue-500 text-white rounded-md w-full mb-2">Edit</button></a>
                                <a href="{{ route('admin.data_mahasiswa.detail') }}"><button
