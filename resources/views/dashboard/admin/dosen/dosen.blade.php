...
@section('content')
    <div class="card-body shadow-[0px_5px_60px_-15px_rgba(0,0,0,0.4)] px-3 py-5 rounded-md">
        ...
        <div class="flex px-5 gap-3">
            ...
            <a href="{{ route('export.dosen') }}"><button
                ...
                <table class="min-w-full divide-y divide-gray-200" id="datatable">
                    <thead class="bg-[#13947D]">
                        <tr>
                            ...
                            <th class="px-2 py-3 border border-gray-300 text-left text-md text-white">Jabatan Akademik</th>
                            <th class="px-2 py-3 border border-gray-300 text-left text-md text-white">Nomor HP</th>
